...
class DBHelper{
  ...
  _onCreate (Database db, int version) async{
    ...
    await db.execute("CREATE TABLE IF NOT EXISTS brand (brand_id INTEGER PRIMARY KEY AUTOINCREMENT, brand_name TEXT NULL, FOREIGN KEY(company_id) REFERENCES company(company_id) int NULL)");
